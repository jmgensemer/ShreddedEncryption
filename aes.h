...
/**** The next few lines have been edited by Fahad Alhajjaj and Nr & Nk have been changed to work with a 256 bit key. ****/
...
/*
	Edited by Fahad Alhajjaj
	E-mail: fhalhajjaj@mix.wvu.edu
	The following functions are written by Fahad Alhajjaj.
*/

/* 
	CipherHelper will determine witch function to call Cipher to encrypt file or InvCipher to decrypt.
	FILE *fileIN: file to be encrypted or decrypted
	FILE *fileOUT: encrypted file or decrpted file
	int size: size of file
	int flag: 0 for decrypting and 1 for encrypting
	unsigned char KeyIn[32]: key used to encrypt and decrypt file
*/
FILE* CipherHelper(FILE *fileIN, FILE *fileOUT, int size, int flag, unsigned char KeyIn[]) {
	int i;
	for(i=0;i<32;i++)
	{
		Key[i]=KeyIn[i];
